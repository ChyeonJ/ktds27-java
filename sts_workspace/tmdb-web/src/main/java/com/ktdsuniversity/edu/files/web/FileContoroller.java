...
import com.ktdsuniversity.edu.files.service.FileService;
...
public class FileContoroller {
	...
	public ResponseEntity<Resource> doDownloadAction(
		...
		// 다운로드 시작
		//Http Response 셋팅
		//Http Reponse Header 셋팅
		HttpHeaders headers = new HttpHeaders();
		// Content-Disposition : 다운로드할 파일의 이름 작성
		//HttpHeaders.CONTENT_DISPOSITION 사용자가 오타 가능하니 이렇게
		// attachment는 파일을 첨부해서 보낸다
//		/filename=" + downLoadVO.getDisplayName() 첨부하는 파일의 이름은 이거다
		...
		// Content-Type : 다운로드할 파일의 마임타임(Mime-Type) 작성
