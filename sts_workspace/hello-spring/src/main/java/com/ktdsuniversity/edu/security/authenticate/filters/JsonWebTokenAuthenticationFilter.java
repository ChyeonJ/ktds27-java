 ...
 * 
 * HttpServletRequest의 header로 전달된 Authorization에 들어 있는
 * JWT를 가져와 분석(벅호화 및 검증)을 진행하고 분석된 결과를
	...
	protected void doFilterInternal(
		...
		if(requestURI.startsWith("/api/")) {
			...
			if(!StringUtils.isEmpty(jsonWebToken)) {
				...
				String email = this.jsonWebTokenAuthenticationProvider.decrpytJsonWebToken(jsonWebToken);
